...
export default async function HomeComponents() {
  ...
  return (
    <>
      <header className='lg:min-h-[80vh] relative bg-main  '>
        <div className='lg:mx-28 mx-4 relative z-10 flex justify-center items-center  flex-col lg:h-[90vh] h-[50vh] '>
          ...
          <Link href='/explore/1' className="rounded-3xl hover:bg-transparent transition-all hover:border-0">Search Now </Link>
          </button>
        </div>
        <Image src={bg} alt='' className='absolute h-full top-0  z-[0] opacity-70 child '/>
        <div className='absolute top-0 bg-main  z-[2] lg:h-[60vh] h-screen w-full my-Ainme '></div>
      </header>
      <Trending/>
      <Popular/>
      <TopRate/>
